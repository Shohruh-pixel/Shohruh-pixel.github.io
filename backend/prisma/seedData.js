...
// Собрано 26.08.2026 обходом сайтов и магазинов приложений. Записано только то, что банк говорит
// о себе сам: отзыв клиента, калькулятор курса на странице и пересказ в поисковой выдаче — не
// источник. Проверено поимённо, потому что в этом проекте уже стояли двенадцать выдуманных лимитов.
//
// Чего здесь нет и почему:
//   Спитамен — на своей странице мобильного банка перечисляет «Курсы валют на текущий момент», то
//     есть просмотр, а не обмен. Отсутствие упоминания не доказывает, что обменять нельзя, поэтому
//     строки нет вовсе — молчание честнее догадки.
//   Арванд — про обмен в приложении говорит только отзыв клиента на сайте банка. Это не банк.
//   Душанбе Сити, Азизи Молия — на главной калькулятор курса. Это счётчик, а не услуга.
//   Хумо — страница «Конвертация валют» существует, но собирается скриптом и текста не отдаёт.
//   Актив, Фридом, ИКБ, Лолс, Матин, МБТ, Ориёнбонк, Сундук, Васл — сайты не открылись отсюда.
//
// Ни один банк, кроме Алифа, не публикует лимит и комиссию обмена в приложении — поэтому строки
// говорят, что возможность есть, и прямо признают, что условия неизвестны. Пообещать «до 10 000»
// там, где банк ничего не обещал, значит отправить человека в банк с чужим числом.
const publishedOnline = {
  ...
  // Банк называет обмен среди возможностей приложения «Эсхата Онлайн» — «КОНВЕРТИРОВАТЬ валюту»:
  //   https://apps.apple.com/tj/app/эсхата-онлайн/id1438481790
  // Ни лимита, ни комиссии банк не публикует, поэтому здесь их нет.
  "eskhata-bank": {
    onlineRu:
      "Обмен есть в приложении «Эсхата Онлайн» — банк называет его среди возможностей. Лимит и комиссию банк не публикует, уточните перед крупным обменом.",
    onlineTj:
      "Мубодила дар барномаи «Эсхата Онлайн» ҳаст — бонк онро дар қатори имкониятҳо номбар мекунад. Лимит ва комиссияро бонк нашр намекунад, пеш аз мубодилаи калон аниқ кунед.",
    onlineUz:
      "Ayirboshlash «Эсхата Онлайн» ilovasida bor — bank uni imkoniyatlar qatorida sanaydi. Limit va komissiyani bank e'lon qilmaydi, katta almashuvdan oldin aniqlang."
  },
  // «Конвертация валют» в описании «Амонат мобайл»:
  //   https://apps.apple.com/tj/app/амонат-мобайл/id1513528648
  "amonatbank": {
    onlineRu:
      "Обмен есть в приложении «Амонат мобайл» — банк называет его среди возможностей мобильного банкинга. Лимит и комиссию банк не публикует, уточните перед крупным обменом.",
    onlineTj:
      "Мубодила дар барномаи «Амонат мобайл» ҳаст — бонк онро дар қатори имкониятҳои бонкдории мобилӣ номбар мекунад. Лимит ва комиссияро бонк нашр намекунад, пеш аз мубодилаи калон аниқ кунед.",
    onlineUz:
      "Ayirboshlash «Амонат мобайл» ilovasida bor — bank uni mobil banking imkoniyatlari qatorida sanaydi. Limit va komissiyani bank e'lon qilmaydi, katta almashuvdan oldin aniqlang."
  }
};
