export default {
  ...
  home: {
    ...
    quickSubtitle: "Kerakli ma'lumotga bir zumda o'ting.",
    ratesAction: "Valyuta kurslari",
    converterAction: "Konverter",
    limitsAction: "Naqd yechish limitlari",
    favoritesAction: "Saralangan banklar",
  ...
  converter: {
    ...
    apiSync: "API ishlayotgan bo'lsa, natija server bilan avtomatik solishtiriladi.",
