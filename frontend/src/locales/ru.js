export default {
  ...
  about: {
    ...
    sourcesText: "Курсы берутся напрямую с сайтов и открытых API самих банков, а где банк их не публикует — из таблицы Национального банка Таджикистана. Источник указан у каждого банка отдельно, здесь и на его странице. Обновление происходит автоматически каждые 3 часа.",
