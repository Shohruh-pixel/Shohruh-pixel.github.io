export default {
  ...
  about: {
    ...
    privacyText: "Мы не просим регистрацию, не собираем имена, телефоны и почту. Нет сторонних счётчиков и рекламных сетей. Избранные банки и выбранный язык хранятся только в вашем браузере и никуда не передаются. Обезличенная статистика посещений ведётся в агрегированном виде — сколько раз открывали страницу, без привязки к человеку.",
    contactTitle: "Связь",
